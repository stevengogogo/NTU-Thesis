        ...
        <div className="container">
          <div className="row margin-vert--lg">
            ...
            <div className="col text--center padding-vert--md">
              <div class="card">
                <div class="card__header">
                  <i className={classnames(styles.icon, styles.telegram)}></i>
                </div>
                <div class="card__body">
                  <p>
                ...
                <div class="card__footer">
                  <Link
                    to="https://app.slack.com/client/T029RQSE6/CLWCBK7FY"
                    class="button button--outline button--primary button--block"
                  >
                    Open
                  </Link>
